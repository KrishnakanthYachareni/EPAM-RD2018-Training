...
import com.epam.rd.weektwo.autoparkingv2.Exceptions.InvalidCommandException;
...
import com.epam.rd.weektwo.autoparkingv2.client.Park;
import com.epam.rd.weektwo.autoparkingv2.client.Report;
import com.epam.rd.weektwo.autoparkingv2.client.Unpark;
		...
		try {
			while (true) {
				...
				case Constants.PARK_COMMAND:
					...
					break;
				// Constants class unpark command
				case Constants.UNPARK_COMMAND:
					...
					break;
				// Constants class report command.
				case Constants.REPORT_COMMAND:
					Report rp = new Report(); // Creating object for Report class
					rp.doTask(manager); // calling doTask method to Report a vehicles.
					break;
				// Constants class exit command.
				case Constants.EXIT:
					return; // return nothing to exit.
				default:
					throw new InvalidCommandException("Enter proper command");
				} // switch end
			} // Loop end
